...
/**
 * Classe responsável por gerenciar os logs dos testes do Cadastro
 * 
 * @author Lei-G
 * @date 2024-04-06 21:30
 */
public class CadastroTestLogger {
    private static final String LOG_FILE = "test-results/CadastroTest.log";
